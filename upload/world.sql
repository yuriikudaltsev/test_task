...
--
-- Хост: localhost
-- Время создания: Янв 17 2023 г., 09:40
...
CREATE TABLE `city` (
  `id` int NOT NULL,
  `name` char(35) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `country_code` char(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `district` char(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `country` (
  ...
  `local_name` char(45) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `government_form` char(45) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `head_of_state` char(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `capital` int DEFAULT NULL,
  `code_2` char(2) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `country` (`code`, `name`, `continent`, `region`, `surface_area`, `indep_year`, `population`, `life_expectancy`, `gnp`, `gnp_old`, `local_name`, `government_form`, `head_of_state`, `capital`, `code_2`) VALUES
...
CREATE TABLE `country_language` (
  `country_code` char(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `language` char(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `is_official` enum('T','F') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'F',
...
--
ALTER TABLE `country_language`
  ADD CONSTRAINT `country_language_ibfk_1` FOREIGN KEY (`country_code`) REFERENCES `country` (`code`);
COMMIT;
